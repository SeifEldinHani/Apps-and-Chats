...
This API enables users to create apps and get an app token by which the user can create chats and send messages. The API uses rabbitmq to schedule creation jobs in non-blocking, asynchronous matter 
